...
function App() {
  ...
  const mintImage = async (tokenURI) => {
    ...
    const transaction = await nft.connect(signer).mint(tokenURI, { value: ethers.utils.parseUnits("1", "ether") }) // sending 1 eth to NFT contract.
    // not to ERC721.sol or ERC721URIStorage.sol
